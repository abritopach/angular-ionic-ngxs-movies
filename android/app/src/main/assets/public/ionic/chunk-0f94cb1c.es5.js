...
Ionic.loadBundle("chunk-0f94cb1c.js", ["exports"], function (n) { window.Ionic.h, n.createThemedClasses = function (n, t, e) { var r = {}; return e.split(" ").forEach(function (e) { return r[e] = !0, n && (r[e + "-" + n] = !0, t && (r[e + "-" + t] = !0, r[e + "-" + n + "-" + t] = !0)), r; }), r; }, n.getClassMap = function (n) { var t = {}; return function (n) { return n ? Array.isArray(n) ? n : n.split(" ").filter(function (n) { return "" !== n.trim(); }) : []; }(n).forEach(function (n) { return t[n] = !0; }), t; }, n.openURL = function (n, t, e, r) {
    ...
    return __awaiter(this, void 0, void 0, function () { var o; return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1: return [2 /*return*/, (_a.sent(), o.push(t, "back" === r ? -1 : 1))];
            case 2: return [2 /*return*/, Promise.resolve()];
        }
    }); });
}, n.getElementClassMap = function (n) { var t = {}; for (var e = 0; e < n.length; e++)
    t[n[e]] = !0; return t; }, n.getButtonClassMap = function (n, t) { return n ? (_a = {}, _a[n] = !0, _a[n + "-" + t] = !0, _a) : {}; var _a; }; });
